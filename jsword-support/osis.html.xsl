...
<!--===========some variables================-->
<xsl:variable name="authorID" select="/osis/osisText/header/work/creator[@role='aut' and @type='ccel']"/>
<xsl:variable name="bookID" select="substring-before(/osis/osisText[@osisIDWork],'_')"/>
<xsl:variable name="osisIDWork" select="/osis/osisText/@osisIDWork"/>
...
<!--=============ABOUT========= -->
      ...
      <p>
        <table>
          <tr><td width="180" align="right" valign="top"><b>Title:</b></td><td width="12"/><td width="400"><xsl:value-of select="/osis/osisText/header/work/title"/></td></tr>
          <tr><td align="right" valign="top"><b>Author(s):</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/creator[@role = 'aut' and @subType = 'file-as']"/>
    ...
    <xsl:if test="/osis/osisText/header/work/publisher != ''"><tr><td align="right" valign="top"><b>Publisher:</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/publisher"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/description != ''"><tr><td align="right" valign="top"><b>Description:</b></td><td/><td><xsl:apply-templates select="/osis/osisText/header/work/description" mode="includeParsing"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/source != ''"><tr><td align="right" valign="top"><b>Source:</b></td><td/><td><xsl:choose><xsl:when test="/osis/osisText/header/work/source[@type = 'URL'] != ''"><a href="{/osis/osisText/header/work/source[@type = 'URL']}"><xsl:value-of select="/osis/osisText/header/work/source[not(@type)]"/></a></xsl:when><xsl:otherwise><xsl:value-of select="/osis/osisText/header/work/source[not(@type)]"/></xsl:otherwise></xsl:choose></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/language != '' and not(starts-with(/osis/osisText/header/work/language, 'en'))"><tr><td align="right" valign="top"><b>Language:</b></td><td/><td>
    <xsl:choose>
    ...
    <xsl:if test="/osis/osisText/header/work/rights != ''"><tr><td align="right" valign="top"><b>Rights:</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/rights"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/date != ''"><tr><td align="right" valign="top"><b>Date Created:</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/date[@subType = 'Created']"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/status != ''"><tr><td align="right" valign="top"><b>Status:</b></td><td/><td><xsl:apply-templates select="/osis/osisText/header/work/status" mode="includeParsing"/></td></tr></xsl:if> 
    <xsl:if test="/osis/osisText/header/work/comments != ''"><tr><td align="right" valign="top"><b>General Comments:</b></td><td/><td><xsl:apply-templates select="/osis/osisText/header/work/comments" mode="includeParsing"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/contributor != ''"><tr><td align="right" valign="top"><b>Contributor(s):</b></td><td/><td>
    ...
    <xsl:if test="/osis/osisText/header/work/subject[@type = 'ccel'] != ''"><tr><td align="right" valign="top"><b>CCEL Subjects:</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/subject[@type = 'ccel']"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/subject[@type = 'LCCN'] != ''"><tr><td align="right" valign="top"><b>LC Call no:</b></td><td/><td><xsl:value-of select="/osis/osisText/header/work/subject[@type = 'LCCN']"/></td></tr></xsl:if>
    <xsl:if test="/osis/osisText/header/work/subject[starts-with(@type, 'lcsh')] != ''"><tr><td align="right" valign="top"><b>LC Subjects:</b></td><td/><td>
