...
public class TarEntry extends Object implements Cloneable
{
     ...
     * @param newFile The file from which to get the header information.
     */
    public void getFileTarHeader(TarHeader hdr, File newFile)
    {
        this.file = newFile;
        ...
        hdr.modTime = newFile.lastModified() / 1000;
        hdr.checkSum = 0;
        hdr.devMajor = 0;
        hdr.devMinor = 0;
    }
