...
public class Grammar {
    ...
    /**
     * Strip of any parts of speech to leave a root word. This class may not be
     * the best place for this code, however I'm not sure if we have a better
     * place for it at the mo. Maybe it should be in passage.PassageUtil?
     * 
     * @param word
     *            The word to strip
    ...
    /**
     * Is this word one of those small words that can slaughter a DB query. An
     * empty string IS a small word.
     * 
     * @param word
     *            The word to test
     */
    ...
    /**
     * The Endings a word can have. These are matched in order so there is no
     * point in having "s" before "es" because the second will not be tried.
     */
