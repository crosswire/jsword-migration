...
/**
 * TeeWriter allows you to have one stream act as a proxy to a number of other
 * streams, so that output to one goes to all of the streams.
 * 
 * @author Joe Walker
 */
public class TeeWriter extends Writer {
    ...
    /**
     * Remove the specified Writer from the list of streams used in all outputs.
     * 
     * @param out
