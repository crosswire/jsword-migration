...
/**
 * Defines the prototypes needed to display a RowTable. Also defines some column
 * indexed concrete methods to access the prototypes.
 * 
...
public abstract class RowColumns extends DefaultTableColumnModel {
    ...
    /**
     * Method getHeaderToolTips gets the tooltips for the headers for all the
     * columns
     * 
    ...
    /**
     * Method getCharacterWidths gets the widths of all the columns, expressed
     * in Standard Width Characters.
     * 
    ...
    /**
     * Method getFixedWidths gives whether a column is not resizable (true) or
     * resizable (false)
     * 
    ...
    /**
     * Method getSortKeys returns the primary (array of size 1) or composite key
     * (size > 1) used for default sorting and for secondary sorting.
     * 
    ...
    /**
     * Method getCharacterWidth gets the width of the column, expressed in
     * Standard Characters
     * 
     * @param columnIndex
     *            int
