...
/**
 * TextViewPanel allow viewing of some text in its own standalone frame. The
 * text to be viewed can be grabbed from a String, a URL, or a file.
 * 
...
public class TextViewPanel extends JPanel {
     ...
     * 
     * @param url
     *            A pointer to the contents of the text area
     */
     ...
     *            The contents of the text area
     * @param header
     *            The string for the header area of the window
     */
