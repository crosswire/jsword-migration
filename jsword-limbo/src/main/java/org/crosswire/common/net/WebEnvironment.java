 ...
 * 
 * <h2>Enabling HTTPS</h2> This could use the HTTPCLient handler from
 * innovation.ch however this fails because there are handlers only for http not
 * https
 ...
 * 
 * <p>
 * If you simply include the HotJava jars in the CLASSPATH then URL will
 * automatically try to use them. However I think they only work at 1.1 Using
 * JDK 1.2 without changing your PATH gives:
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * Adding the HotJava bin dir to the path (so that we get a look at jsafe.dll
 * alters this (slightly) so we get a windows linker error on javai.dll (from
 * 1.1) Adding the HotJava/runtime dir to the path too changes the error to:
 * 
 * <pre>
 ...
 * 
 * <p>
 * This attempts to make us use the SSLava handlers, this works, but it costs
 * $2500
...
public class WebEnvironment {
    ...
    */
     ...
     * 
     * public void alert(String contents) { log.fine(contents); }
     * 
     * /** Works out the reply number 404 or something
     */
