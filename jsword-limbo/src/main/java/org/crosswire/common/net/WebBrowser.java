...
public class WebBrowser {
     ...
     */
    /*
     * public void addProxyAuth(String username, String password) { String plain
     * = username+":"+password; String encoded = "Basic "+new
     * sun.misc.BASE64Encoder().encode(plain.getBytes()); Header header = new
     * Header("Proxy-Authorization", encoded); addHeader(header); }
     */
