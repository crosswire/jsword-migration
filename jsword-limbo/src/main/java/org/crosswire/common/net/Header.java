...
/**
 * A set of Headers are set from the server to the browser before the actual web
 * page data is sent, these headers include meta-information about the data
 * including Cookies
 * 
 * @author Joe Walker
 */
public class Header implements Cloneable {
    ...
    /**
     * Returns the name of the header. You cannot change the name after the
     * header is created.
     * 
    ...
    /**
     * If the name and value of the Header are null then the header is not valid
