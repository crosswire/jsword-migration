...
public final class Validator {
    ...
    /**
     * Check that the given string contains letters (upper and lower), space and
     * numbers only. In effect there can be no control characters or
     ...
     * simple punctuation only. In effect there can be no control characters or
     * dangerous punctuation. This ensures that the string can be safely
     * displayed in a web browser without side effects. The allowed punctuation
     * marks are [comma], [apostrophe], [period], [minus], [query], [bang],
     * [quote], [slash], [open paren], [close paren] and [colon]
     * 
     * @param test
     *            The string to check
     * @return true if the string passes the tests specified
     ...
     * return, ff or tab) or any triangular brackets or ampersands. i.e. nothing
     * that HTML regards as special.
     * 
     * @param test
     *            The string to check
     * @return true if the string passes the tests specified
     ...
     * We should reject all of the following: a, a@b, a@b.c. There is probably a
     * lot more we could do to become an rfc822 strict tester, probably mostly
     * in the character set arena. I've seen a regex to do this better, but is
     * is very unmaintainable and it requires a regex library.
     * 
     * @param text
     *            The string to check for potential validity
     * @return true if the string passes the tests specified
     */
