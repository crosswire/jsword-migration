...
/**
 * Various utilities for examining the running Threads and controlling their
 * execution.
 * 
...
public final class ThreadUtil {
    ...
    /**
     * Sleep and don't think about throwing. Mostly when a thread calls sleep
     * you need to wrap it in a special try-catch block to get hold of the
     * InterruptedException - which is rarely called and mostly ignored. This
     * code takes care of the ignoring, and simply logs some stuff if
     * InterruptedException do happen.
     * 
     * @param millis
    ...
    /**
     * Create a StringArray (mostly for debugging) detailing the current
     * Threads, starting at the root ThreadGroup
     * 
    ...
    /**
     * Create a StringArray (mostly for debugging) detailing the current
     * Threads, starting at the specified ThreadGroup
     * 
     * @param base
