 ...
 *
 * ID: $Id: ReflectionUtil.java 1505 2007-07-21 19:40:19Z dmsmith $
 */
...
public final class ReflectionUtil
{
     ...
     * Note: a constructor that takes a boolean needs a type of boolean.class, but a parameter of type Boolean. Likewise for other primitives. If this is needed, do not call this method.
     * 
     * @param className the full class name of the object
     ...
     * Note: a constructor that takes a boolean needs a type of boolean.class, but a parameter of type Boolean. Likewise for other primitives.
     * 
     * @param className the full class name of the object
     ...
     * @param methodName The text of the invocation, for example "getName"
     ...
     * 
     * @param call The text of the invocation, for example "java.lang.String.getName"
     * @param params For example new Object[] { ...}
     */
     ...
     * 
     * Note: a method that takes a boolean needs a type of boolean.class, but a parameter of type Boolean. Likewise for other primitives. If this is needed, do not call this method.
     * @param clazz the class of the object
     * @param obj the object having the method, or null to call a static method
     ...
     * Call a method on an object, or statically, with the supplied parameters.
     * 
     * Note: a method that takes a boolean needs a type of boolean.class, but a parameter of type Boolean. Likewise for other primitives.
     * @param clazz the class of the object
     * @param obj the object having the method, or null to call a static method
     * @param methodName the method to be called
     * @param params the parameters
     * @param paramTypes the types of each of the parameters
     * @return whatever the method returns
     * @throws NoSuchMethodException
     * @throws IllegalAccessException
     * @throws InvocationTargetException
     ...
     * @param params the types to describe
