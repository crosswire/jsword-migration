 ...
 *
 * ID: $Id: SwordBookDriver.java 1474 2007-07-04 23:27:59Z dmsmith $
 */
            ...
            for (int i = 0; i < bookConfs.length; i++)
            {
                ...
                try
                {
                    ...
                    if (!valid.contains(book))
                    {
                        ...
                        //TODO(PRB): re-enable this once the index classes are changed
                        //into services.
...
//                        else
    ...
    {
        Books.installed().addBook(createBook(sbmd));
    }

    /**
     * Create a Book appropriate for the BookMetaData
     */
    private static Book createBook(SwordBookMetaData sbmd) throws BookException
    {
