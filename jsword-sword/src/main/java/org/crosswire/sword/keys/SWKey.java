...
/**
 * swkey.cpp - code for base class 'SWKey'. SWKey is the basis for all types of
 * keys for indexing into modules (e.g. verse, word, place, etc.)
 */
public class SWKey implements Cloneable, Comparable {
    ...
    /**
     * SWKey::Error - Gets and clears error status. RET: error status
     */
    public int getError() {
        int retval = error;
     ...
     * 
     * ENT: ikey - key to compare with this one RET: > 0 if this key is greater
     * than compare key &lt; 0
     */
     ...
     * 
     * ENT: increment - Number of entries to jump forward RET: *this public void
     * next(int i) { error = KEYERR_OUTOFBOUNDS; }
     */
     ...
     * 
     * ENT: decrement - Number of entries to jump backward RET: *this public
     * void previous(int i) { error = KEYERR_OUTOFBOUNDS; }
     */
